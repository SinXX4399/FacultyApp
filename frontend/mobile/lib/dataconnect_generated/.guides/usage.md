...
```dart
ExampleConnector.instance.CreateBranch(createBranchVariables).execute();
ExampleConnector.instance.createFaculty(createFacultyVariables).execute();
...
ExampleConnector.instance.GetUsers(getUsersVariables).execute();
